 ...
 *
 * - talksReducers function
 *  - should return the initial state when give by unknow action
 *  - should return the talks when given by RECEIVE_TALKS action
 *  - should return the talsk with the new talk when given by ADD_TALKS action
 *  - should return the talks with te toggle like talk when given by TOGGLE_LIKE_TALK action
 *
 */
...
describe('talkReducer function', () => {
  ...
  it('should return the talks with the toggle like talk when given by TOGGLE_LIKE_TALK action', () => {
    // arrange
    const initialState = [
      {
        id: 'talk-1',
